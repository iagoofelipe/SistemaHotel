...
export const TABLE_RESERVAS = {
    parentId: 'container-reservas',
    name: 'reservas',
    columns: ['Hóspede', 'Quarto', 'Andar', 'Check-In', 'Check-Out'],
    title: 'Todas as Reservas',
};

export const TABLE_CLIENTES = {
    parentId: 'container-clientes',
    name: 'clientes',
    columns: ['Nome', 'E-mail'],
